...
let SimpleGalleryCard = class extends i {
  ...
  render() {
    ...
    return x` <ha-card header="${title}">
      ...
      <div class="controlBox">
        ...
        ></ha-icon>
        ${this.hasDelete ? x`
              ${this.mediaListDelete.length == this.mediaList.length ? x`<ha-icon
        ...
        <span style="float:right">
          ${this.mediaListDelete.length > 0 && this.hasDelete ? x`
                ...
                ></ha-icon>
              ` : ``}
          ${this.confirmDelete && this.hasDelete ? x`
                <ha-icon
      ...
      <div class="pagesBox">
        ${Array(this.maxPage).fill(0).map(
      (_2, i2) => x`<span
                @click="${() => this._setPage(i2 + 1)}"
                class="pageNumber"
                style="${this.currentPage == i2 + 1 ? i$3`
      ...
      (mediaItem) => x`
            ...
            >
              ...
              <td>
                ...
                ${this.hasDelete ? x`
                      <br />
                      ${this.mediaListDelete.includes(mediaItem) ? x` <ha-icon
  ...
  _removeMediaToDelete(mediaItem) {
    this.mediaListDelete = this.mediaListDelete.filter((m2) => m2 !== mediaItem);
    this.requestUpdate();
  }
};
SimpleGalleryCard.styles = styles;
__decorateClass([
  n2({ attribute: false })
], SimpleGalleryCard.prototype, "_hass", 2);
__decorateClass([
  r()
], SimpleGalleryCard.prototype, "config", 2);
__decorateClass([
  r()
], SimpleGalleryCard.prototype, "mediaList", 2);
__decorateClass([
  r()
], SimpleGalleryCard.prototype, "mediaListShown", 2);
__decorateClass([
  r()
], SimpleGalleryCard.prototype, "mediaListDelete", 2);
__decorateClass([
  r()
], SimpleGalleryCard.prototype, "mediaItemShown", 2);
__decorateClass([
  r()
], SimpleGalleryCard.prototype, "currentPage", 2);
__decorateClass([
  r()
], SimpleGalleryCard.prototype, "pageSize", 2);
__decorateClass([
  r()
], SimpleGalleryCard.prototype, "maxPage", 2);
__decorateClass([
  r()
], SimpleGalleryCard.prototype, "confirmDelete", 2);
__decorateClass([
  r()
], SimpleGalleryCard.prototype, "hasDelete", 2);
__decorateClass([
  r()
], SimpleGalleryCard.prototype, "isDebugMode", 2);
SimpleGalleryCard = __decorateClass([
  t("simple-gallery-card")
], SimpleGalleryCard);
export {
  SimpleGalleryCard
};
